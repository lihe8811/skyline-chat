...
export const DalleManifest: BuiltinToolManifest = {
  ...
  systemRole: `Whenever a description of an image is given, use lobe-image-designer to create the images, use exactly the same prompts and the same language that the user provides.`,
  type: 'builtin',
};
